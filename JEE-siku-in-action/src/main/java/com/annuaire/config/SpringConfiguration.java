...
@Configuration
@ComponentScan("com.annuaire.dao")
...
//		dataSource.setPassword("");
	...
	/*
	 * Construction de l'EMF � partir de la source de donn�es et du choix
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		em.setPackagesToScan(new String[] { "com.annuaire.model" });
	...
	/*
	 * Construction d'un gestionnaire de transaction en liaison avec l'usine � EM.
	 */
	@Bean
